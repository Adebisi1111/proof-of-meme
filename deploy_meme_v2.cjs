...
const code = fs.readFileSync('/home/administrator/genlayer-project/contracts/proof_of_meme.py');
...
client.deployContract({
  ...
  console.log('Fresh contract at:', receipt.txDataDecoded?.contractAddress || receipt.data?.contractAddress);
